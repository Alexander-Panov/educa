...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def dispatch(self, request, module_id, model_name, id=None):
        """
        :param request:
        :param module_id: Модуль, с которым ассоциировано содержимое
        :param model_name: Имя модели содержимого
        :param id: ИД обновляемого объекта. Если None - объект создается
        :return:
        """
